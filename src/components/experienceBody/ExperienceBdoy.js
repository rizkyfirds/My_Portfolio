  ...
  return (
    <div className="flex h-full gap-4 overflow-y-auto">
      <div className="hidden md:flex w-1/6 md:w-1/4 justify-end">
        <IoArrowForwardCircleOutline className="text-3xl md:text-9xl text-white font-bold mt-1"/>
      </div>
      <div className="md:w-3/4 mx-4">
        <p className="text-3xl md:text-9xl mb-2 md:mb-14 text-white font-bold">Experience</p>
